...
public class LoggerStartupListener extends ContextAwareBase implements LoggerContextListener, LifeCycle {
    ...
    public void start() {
        ...
        if (logFilePath == null){
            logFilePath = ".." + File.separatorChar + "log";
        }
        String userHome = new File(logFilePath).getAbsolutePath();
        String logFile = "shelloidVPT";
        Context context = getContext();
        System.out.println("Log files could be found in " + userHome + File.separatorChar + logFile + ".XXX.log");
        /* DONO use Logger here since the logger wont be inited and throws NullPointerException */
