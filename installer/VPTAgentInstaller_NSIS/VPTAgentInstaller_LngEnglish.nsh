; VPTAgentInstaller_LngEnglish.nsh
...
; English localization for additional messages
  ...
  ${LangFileString} MSG_FINISHPAGE_RUN_TEXT        "Install VPT as a service"
  ${LangFileString} MSG_WELCOMEPAGE_TITLE          "Welcome to Shelloid VPT Agent 3 Installer"
  ${LangFileString} MSG_WELCOMEPAGE_TEXT           "The installer will guide you through installation of the software on your computer. To proceed, click Next."

  ${LangFileString} MSG_FEEDBACK_TEXT              "Would you like to share with us your thoughts on how we could make VPT Agent 3 better? Fill in a 5-minute feedback form and optionally enter the prize draw!"
